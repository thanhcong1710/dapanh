...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::group(['middleware' => 'admin'], function ($router) {
        ...
        Route::get('/user/get_img_active/{user_id}', 'UserController@getImgByUser');
        Route::post('/user/change_img_show', 'UserController@changeImageShow');
        Route::get('/user/images', 'UserController@getListImage');
    });
});
